...
class TestProxyPerformance:
    ...
    def test_proxy_processing_faster(self):
        ...
        large_image = Image.new('RGB', (6000, 4000), color='blue')
        ...
        for _ in range(5):
            ...
            result = result.resize((result.width, result.height))
    ...
    def test_proxy_pixel_count_ratio(self):
        ...
        large_image = Image.new('RGB', (6000, 4000), color='red')
    ...
    def test_proxy_generation_time(self):
        ...
        large_image = Image.new('RGB', (6000, 4000), color='green')
    ...
    def test_proxy_not_needed_for_small_images(self):
        ...
        small_image = Image.new('RGB', (800, 600), color='yellow')
        ...
        assert pm.proxy_size == small_image.size
    ...
    def test_proxy_maintains_aspect_ratio(self):
        ...
        # Wide image
        wide_image = Image.new('RGB', (4000, 2000), color='cyan')
        ...
        # Tall image
        tall_image = Image.new('RGB', (2000, 4000), color='magenta')
