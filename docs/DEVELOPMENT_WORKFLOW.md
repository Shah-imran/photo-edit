...
### Planning and specs (read first)

- **[planning/PRODUCT_ROADMAP.md](planning/PRODUCT_ROADMAP.md)** -- what to build (Lightroom phases, feature catalog, milestones).
- **[planning/INCREMENTAL_WORKFLOW.md](planning/INCREMENTAL_WORKFLOW.md)** -- how to build it: phase order, **mandatory detailed implementation plan before code (section 4)**, persistence, professional shell (6.1), logging, decoupling.
- **[planning/implementation-notes/](planning/implementation-notes/)** -- one approved markdown note per slice before implementation starts.
...
3. **Follow UI Guidelines**: See [UI_UX.md](UI_UX.md)
...
- [TESTING.md](TESTING.md) - Complete testing approach
- [ARCHITECTURE.md](ARCHITECTURE.md) - Architecture guidelines
- [planning/PRODUCT_ROADMAP.md](planning/PRODUCT_ROADMAP.md) - Product phases, feature catalog, and milestones
